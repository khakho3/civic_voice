...
android {
    ...
    buildTypes {
        release {
            // Existing 1.0.x APKs were distributed with this signing identity.
            // Keep it until a managed release-key migration is planned; changing
            // keys now would force every current tester to uninstall first.
