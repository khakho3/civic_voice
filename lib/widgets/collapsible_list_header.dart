...
/// module needed the identical treatment for its own filter chrome
/// (Analytics Dashboard, Municipal Performance) — any screen with fixed
/// chrome eating vertical space above a scrollable list should reuse this
/// rather than reimplementing it per module.
///
