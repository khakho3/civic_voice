    ...
    return ValueListenableBuilder<ThemeMode>(
      ...
      builder: (context, themeMode, _) {
        return MaterialApp(
          ...
          // Citizen is the only module currently wired into real named
          // routes below — admin/ministry/municipal/maintenance don't have
          // role-gated entry points yet (no auth/RBAC exists), so reaching
          // them for manual QA still means temporarily swapping this
          // `routes`/`initialRoute` pair for one of their own screens.
          routes: {
